            ...
            <div className="pl-[85px] ">
              ...
              <div className="pt-[30px] pb-[45px] mb-[40px] relative ">
                ...
                <div>
                  <a
                    href="#"
                    className="py-5 px-9 whitespace-nowrap rounded-[80px] text-white bg-opacity-20 bg-white font-['Poppins']  text-base font-bold shadow-md hover:shadow-[#9ECB1D] inline-block align-middle relative pl-[80px] pr-[40px]"
                    target="_BLANK"
                  >
                  ...
                  <a
                    href="#"
                    className="py-5 px-8 whitespace-nowrap rounded-[80px] text-black  font-['Poppins']  text-base ml-[25px] font-bold bg-[#9ECB1D]  hover:text-white hover:bg-[#232323] hover:shadow-md hover:shadow-[#9ECB1D] inline-block align-middle relative p-[12px ,0] pl-[80px] pr-[40px]"
                  >
                    <i className="absolute top-[25%] left-[25px]">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
